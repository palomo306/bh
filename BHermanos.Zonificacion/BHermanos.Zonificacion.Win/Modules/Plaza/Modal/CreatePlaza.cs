...
{
    public partial class CreatePlaza : Form
    {
        #region Propiedades
        public string Color
        {
        ...
        public List<BE.Plaza> ListPlazas { get; set; }
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            {
                BE.Plaza existZona = ListPlazas.Where(z => z.Nombre.ToLower() == txtNombre.Text.ToLower() && z.Id != ZoneEditId).FirstOrDefault();
                if (existZona == null)
                    this.DialogResult = DialogResult.OK;
                else
                {
                    MessageBox.Show("Ya existe otra plaza con el mismo nombre, por favor escriba otro.", "Error de validación", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtNombre.Focus();
                }
            }
            else
            {
                MessageBox.Show("Por favor seleccione un color y escriba un nombre para la nueva plaza", "Error de validación", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtNombre.Focus();
            }
        }
        #endregion
